package io.github.ztoany.sample.springboot3.odata4.olingo.odata;
...
public record JPACustomEdmNameBuilder(@Nonnull String namespace, @Nonnull boolean nameFirstToLower) implements JPAEdmNameBuilder {
    ...
    public JPACustomEdmNameBuilder(@Nonnull String namespace) {
    ...
    public String buildEntityTypeName(final EntityType<?> jpaEntityType) {
        ...
        if (alias == null) {
            return nameFirstToLower ? firstToLower(jpaEntityType.getName()) : jpaEntityType.getName();
        } else {
            return alias.name();
        }
    }
    ...
    public final String buildPropertyName(final String jpaAttributeName) {
        return nameFirstToLower ? firstToLower(jpaAttributeName) : firstToUpper(jpaAttributeName);
    }
